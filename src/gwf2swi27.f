...
C         SWI DIMENSIONS
        ...
        !INTEGER, SAVE, POINTER :: IANTILOCKOPT
        !INTEGER, SAVE, POINTER :: ISWI2ADOPT
...
C           SWI DIMENSIONS
          ...
          !INTEGER, POINTER :: IANTILOCKOPT
          !INTEGER, POINTER :: ISWI2ADOPT
...
C---------UPDATE ZETA FOR UPPER SURFACE FOR CONVERTIBLE LAYERS
        ...
        END DO
!C
!C---------EXECUTE TIP AND TOE MOVEMENT AND ANTILOCKING IF ISWI2ADOPT IS 1
!        IF (ISWI2ADOPT.NE.0) THEN
!C
...
C
C     ******************************************************************
C     PREVENT SURFACES FROM LOCKING - ANTILOCKING IS CONSTRAINED BY
C       BY THE PRODUCT OF ALPHA AND THE MINUMUM CELL THICKNESS
C     ******************************************************************
C
C     SPECIFICATIONS:
C     ------------------------------------------------------------------
